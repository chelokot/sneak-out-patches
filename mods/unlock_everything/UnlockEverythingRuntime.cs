...
internal static class UnlockEverythingRuntime
{
    ...
    public static void Initialize(ManualLogSource logger, UnlockEverythingConfig configuration)
    {
        ...
        _researchLogPath = Path.Combine(Paths.BepInExRootPath, "profile-reports", "unlock-everything-research.log");
        _harmony ??= new Harmony(UnlockEverythingPlugin.PluginGuid);
        _harmony.PatchAll();
        UnlockEverythingStub.Initialize();

...
| `locker-stun-fix` | Locker Stun Fix | Yes | Prevents an unwanted stun and Boo cooldown when another player opens your occupied locker, and highlights the valid Boo stun zone. |

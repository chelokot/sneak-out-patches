...
internal static class UnlockEverythingStub
{
    ...
    public static string GetProfileStorageKey()
    {
        lock (Sync)
        {
            var currentClientCache = UnlockEverythingRuntime.CurrentClientCache;
    ...
    public static string GetLegacyProfileStorageKey()
    {
        lock (Sync)
        {
            var currentUserId = UnlockEverythingRuntime.CurrentClientCache?.UserWebPlayer?.BaseData?.PlayerId;
